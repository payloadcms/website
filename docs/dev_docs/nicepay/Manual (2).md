---
title: "Manual"
source: "https://developers.nicepay.co.kr/manual-card-keyin.php"
author:
published:
created: 2025-11-29
description:
tags:
  - "clippings"
---
![](https://developers.nicepay.co.kr/images/card_keyin_flow/Card_Keyin_Flow.png)

| 파라미터명 | 파라미터설명 |
| --- | --- |
| TID | 30 byte 필수 거래 ID, 예) nictest00m01011904191651321677   TID 생성 규칙에 대한 상세 내용은 [FAQ 내 TID 생성 규칙 항목](https://developers.nicepay.co.kr/tip.php#1652) 참고 |
...
| EncData | 512 byte 필수 결제 정보 암호화 데이터      \- 암호화 알고리즘: AES128/ECB/PKCS5padding   \- 암호화 결과 인코딩: Hex Encoding   \- 암호 Key: 가맹점에 부여된 MerchantKey 앞 16자리      결제정보 암호화 생성 규칙: Hex(AES(CardNo=value&CardExpire=YYMM&BuyerAuthNum=value&CardPwd=value))   \*파라미터 상세 정보는 아래 "EncData 하위 파라미터 상세" 내용 참고 |
