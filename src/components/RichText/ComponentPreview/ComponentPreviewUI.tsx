...
type Props = {
  isV4Preview: boolean
  renderPreview: (theme: PreviewTheme) => React.ReactNode
  selectedExample?: ComponentExample
  version?: string
}

export const ComponentPreviewUI: React.FC<Props> = ({
  isV4Preview,
  renderPreview,
  selectedExample,
  version,
  ...
  return (
    <section className={classes.preview}>
      ...
      {activeTab === 'preview' ? (
        ...
        >
          <div
            className={classes.versionScope}
            data-payload-preview-version={isV4Preview ? 'v4' : 'v3'}
            data-theme={previewTheme}
          >
