      ...
      <Gutter>
        ...
        <Grid>
          <Cell cols={8} colsM={8}>
            ...
            <p>
              Your privacy is important to us. It is Payload CMS, INC.'s policy to respect your
            ...
            <p>
              ...
              aware that those sites and services have their own privacy policies. After following a
              link to any third-party content, you should read their posted privacy policy
            ...
            <p>
              “Automatically collected” information refers to any information automatically sent by
            ...
            <p>
              ...
              visit, the time spent on each page, and other details about your visit.
            </p>
            <p>
              ...
              trying to do when the error happened, and other technical information relating to the
              problem. You may or may not receive notice of such errors, even in the moment they
            ...
            <p>
              ...
              recommend checking the policies of your device manufacturer or software provider to
            ...
            <ul>
              ...
              <li>Purchase a Payload Cloud subscription</li>
              <li>Accept an invite to join a team</li>
              <li>Install the Payload CMS GitHub Application</li>
            ...
            <p>
              Aside from our website, we also collect personal information when you do any of the
              following on third-parties we use:
            </p>
            <li>Join our Discord</li>
            <li>Submit information to GitHub</li>
            ...
            <p>
              ...
              information about currency and language to provide you with an enhanced experience of
            ...
            <p>
              ...
              policy. For example, if you have provided us with personal information as part of
              creating an account with us, we may retain this information for the duration your
              account exists on our system. If your personal information is no longer required for
              this purpose, we will delete it or make it anonymous by removing all details that
              identify you.
            </p>
            <p>
            ...
            <p>
              ...
              about general usage. Participation in this is completely optional and can be opted out
              of.
            </p>
            <p>
              This data is super important to us and helps us accurately understand how we are
              growing and what we can do to build the software into everything that it can possibly
              be. The telemetry that we collect also help us demonstrate our growth in an accurate
              manner, which helps us as we seek investment to build and scale our team. If we can
              accurately demonstrate our growth, we can more effectively continue to support Payload
            ...
            <ul>
              ...
              <li>NODE_ENV</li>
              <li>
                Environment IDs that help us understand how many active devs are working on Payload
                at a given time
              </li>
              <li>Anonymous user IDs that sign into the admin panel</li>
              <li>
                Generated project IDs that help us understand how many projects are currently built
                using Payload
              </li>
            </ul>
            <p>
              <strong>
                ...
                key, which means that there is absolutely no way that Payload can use the telemetry
                data we collect to tie the data back to an individual or project. All data is
                entirely anonymous.
              </strong>
            </p>
            ...
            <p>
              ...
              18, and we do not knowingly collect personal information about children under 18.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                and server providers, analytics, error loggers, debt collectors, maintenance or
              ...
              <li>
                an entity that buys, or to which we transfer all or substantially all of our assets
                and business
              </li>
            </ul>
            ...
            <p>
              ...
              your personal information for direct marketing purposes, you may change your mind at
              any time by contacting us using the details below.
            </p>
            <p>
              <strong>Access:</strong>&nbsp;You may request details of the personal information that
              we hold about you.
            </p>
            <p>
              <strong>Correction:</strong>&nbsp;If you believe that any information we hold about
              you is inaccurate, out of date, incomplete, irrelevant, or misleading, please contact
              us using the details provided in this privacy policy. We will take reasonable steps to
              correct any information found to be inaccurate, incomplete, misleading, or out of
              date.
            </p>
            <p>
              ...
              information is required to provide you with a particular service or offer (for example
              processing transaction data), we will not deny you goods or services and/or charge you
              different prices or rates for goods or services, including through granting discounts
              or other benefits, or imposing penalties, or provide you with a different level or
            ...
            <p>
              ...
              protection law and wish to make a complaint, please contact us using the details below
              and provide us with full details of the alleged breach. We will promptly investigate
              your complaint and respond to you, in writing, setting out the outcome of our
              investigation and the steps we will take to deal with your complaint. You also have
              the right to contact a regulatory body or data protection authority in relation to
              your complaint.
            </p>
            <p>
              ...
              provided in the communication. We may need to request specific information from you to
            ...
            <p>
              If we or our assets are acquired, or in the unlikely event that we go out of business
              or enter bankruptcy, we would include data, including your personal information, among
              the assets transferred to any parties who acquire us. You acknowledge that such
              transfers may occur, and that any parties who acquire us may, to the extent permitted
              by applicable law, continue to use your personal information according to this policy,
              which they will be required to assume as it is the basis for any ownership or use
            ...
            <p>
              ...
              Privacy Act and the Australian Privacy Principles in the Privacy Act. You acknowledge
              that if any such third party engages in any act or practice that contravenes the
              Australian Privacy Principles, it would not be accountable under the Privacy Act, and
            ...
            <p>
              The GDPR distinguishes between organisations that process personal information for
              ...
              We, Payload CMS, INC., located at the address provided in our Contact Us section, are
            ...
            <p>
              ...
              fairly, and in a transparent manner. If we seek your consent to process your personal
              information, and you are under 16 years of age, we will seek your parent or legal
              guardian’s consent to process your personal information for that specific purpose.
            </p>
            <p>
            ...
            <p>
              ...
              consent, please feel free to enquire using the details provided in the Contact Us
            ...
            <p>
              ...
              use your personal and payment information in order to process and deliver your order.
            </p>
            ...
            <p>
              ...
              further enquiries about how we retain personal information in order to comply with the
              law, please feel free to enquire using the details provided in the Contact Us section
            ...
            <p>
              ...
              appropriate safeguards, for example by using standard data protection clauses approved
              by the European Commission, or the use of binding corporate rules or other legally
              accepted means.
            </p>
            ...
            <p>
              ...
              processing of your personal information if (i) you are concerned about the accuracy of
              your personal information; (ii) you believe your personal information has been
            ...
            <p>
              ...
              personal information we hold about you at any time, and we will take reasonable steps
              to delete your personal information from our current records. If you ask us to delete
              your personal information, we will let you know how the deletion affects your use of
              our website or products and services. There may be exceptions to this right for
              specific legal reasons which, if applicable, we will set out for you in response to
              your request. Please be aware that search engines and similar third parties may still
              retain copies of your personal information that has been made public at least once,
            ...
            <p>
              ...
              policy with “Request for California privacy information” in the subject line. You may
              make this type of request once every calendar year. We will email you a list of
              categories of personal information we revealed to other organisations for their
            ...
            <p>
              ...
              browser’s capabilities. Please refer to the Cookies section of this privacy policy for
              more information.
            </p>
            <h4>CCPA-permitted financial incentives</h4>
            <p>
              In accordance with your right to non-discrimination, we may offer you certain
              financial incentives permitted by the CCPA that can result in different prices, rates,
              or quality levels for the goods or services we provide.
            </p>
            <p>
            ...
            <ul>
              <li>
                Identifiers, such as name, email address, phone number account name, IP address, and
                an ID or number assigned to your account.
              </li>
              <li>
            ...
            <p>
              If you are a California resident, you have rights to delete your personal information
              we collected and know certain information about our data practices in the preceding 12
            ...
            <p>
              If you are a California resident, in addition to the rights discussed above, you have
              the right to request information from us regarding the manner in which we share
            ...
            <p>
              ...
              this privacy policy. Requests must include “California Privacy Rights Request” in the
              first line of the description and include your name, street address, city, state, and
              ZIP code.
            </p>
            <h3>Contact Us</h3>
            <p>
            ...
            <p>Dan Ribbens https://payloadcms.com/contact</p>
            <h2>Cookie Policy</h2>
            <p>
              ...
              part of Payload CMS, INC.'s privacy policy. It covers the use of cookies between your
              device and our site.
            </p>
            <p>
            ...
            <p>
              ...
              refuse cookies from&nbsp;<a href="https://payloadcms.com/">https://payloadcms.com</a>.
            ...
            <p>
              ...
              allows the site to recognize your web browser when you return, additional data that
            ...
            <p>
              ...
              website you’re visiting (first-party) or by third-party services. They do not collect
            ...
            <p>
              ...
              settings you may configure on the website you’re visiting (like language and time zone
